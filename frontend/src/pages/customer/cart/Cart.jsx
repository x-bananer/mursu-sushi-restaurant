            ...
            <article className="cart-item">
              <div className="cart-item__content">
                <div className="cart-item__main">
                  <h2 className="cart-item__title">Sake Sashimi</h2>
                  <p className="cart-item__description">
                    Premium Atlantic salmon, hand-sliced, served with fresh wasabi
                    and aged soy.
                  </p>
                  <button className="btn btn--link cart-item__btn" type="button">
                    Remove
                  </button>
                </div>
            ...
            <article className="cart-item">
              <div className="cart-item__content">
                <div className="cart-item__main">
                  ...
                  <p className="cart-item__description">
                    Hokkaido scallops, sweet and firm. Two pieces per serving.
                  </p>
                  <button className="btn btn--link cart-item__btn" type="button">
                    Remove
                  </button>
        ...
        <section className="cart-page__section payment">
          ...
          <button className="payment__option" type="button">
            ...
            <span className="payment__main">
              ...
              <span className="payment__description">Instant confirmation</span>
            </span>
      ...
      <aside className="cart-page__summary order-summary">
        <div className="order-summary__container">
          ...
          <div className="order-summary__total">
            ...
            <span className="order-summary__total-value">€43.90</span>
          </div>
          <button className="btn btn--dark order-summary__button" type="button">
            Pay €43.90
          </button>
          <p className="order-summary__caption">
            By proceeding, you agree to Mursu’s terms of service and privacy policy.
          </p>
        </div>
      </aside>
    </div>
