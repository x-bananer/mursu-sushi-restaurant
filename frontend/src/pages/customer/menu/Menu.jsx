      				...
      				<section className="menu-page__hero">
      					<div className="menu-page__hero-main">
      						...
      						<p className="menu-page__subtitle">
      							Browse the menu, choose your favorites, and add them
      							to cart to build your order.
      						</p>
      					</div>
      					<aside className="menu-page__hero-side">
      						<div className="sticker">
      							...
      							<p className="sticker__description">
      								...
      								ginger. Served with soy sauce and a small seaweed
      								salad.
      							</p>
      				...
      				<section className="menu-grid">
      					<article className="menu-card menu-card--light">
      						...
      						<div className="menu-card__badges">
      							<span className="menu-card__special-tag">Today's special</span>
      						...
      						<p className="menu-card__description">
      							...
      							seaweed salad. A rich, buttery selection for guests
      							who want a clean salmon-focused plate.
      						</p>
      						<div className="menu-card__footer">
      							<button className="btn btn--small btn--accent" type="button">
      								♥
      							</button>
      					...
      					<article className="menu-card">
      						...
      						<p className="menu-card__description">
      							...
      							ginger. Served with soy sauce and marinated cucumber.
      							A leaner, deeper-flavoured cut with a clean finish.
      						</p>
      						<div className="menu-card__footer">
      							<button className="btn btn--small btn--accent" type="button">
      								♥
      					...
      					<article className="menu-card menu-card--light">
      						...
      						<p className="menu-card__description">
      							...
      							Served with ponzu, pickled daikon, and a herb salad.
      							A delicate, slightly creamy plate with bright heat and
      							acidity.
      						</p>
      						<div className="menu-card__footer">
      							<button className="btn btn--small btn--accent" type="button">
      					...
      					<article className="menu-card">
      						...
      						<p className="menu-card__description">
      							6 slices Hotate scallop sashimi with yuzu salt and
      							fresh wasabi. Served with ponzu and cucumber salad. A
      							sweet, soft-textured option with a light citrus lift.
      						</p>
      						<div className="menu-card__footer">
      							<button className="btn btn--small btn--accent" type="button">
      								♥
      					...
      					<article className="menu-card">
      						...
      						<p className="menu-card__description">
      							7 slices poached octopus with pickled cucumber and
      							house ponzu. Served with steamed rice and miso soup. A
      							firmer bite with bright, savoury dressing and a light
      							set finish.
      						</p>
      						<div className="menu-card__footer">
      							<button className="btn btn--small btn--accent" type="button">
