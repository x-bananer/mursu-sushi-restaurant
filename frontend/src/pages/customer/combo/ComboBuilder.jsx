    ...
    <div className="combo-page">
      <div className="combo-page__main">
        ...
        <section className="combo-section">
          ...
          <div className="combo-section__grid combo-section__grid--three">
            <button className="combo-card" type="button">
              ...
              <span className="combo-card__text">Hand-pulled wheat</span>
              <span className="combo-card__price">9.00</span>
              <span className="combo-card__mobile-action">
                <span className="btn btn--light btn--small">+ ADD</span>
              </span>
            </button>
            <button className="combo-card combo-card--selected" type="button">
              <span className="combo-card__title">Shari Rice</span>
              <span className="combo-card__text">Vinegared koshihikari</span>
            ...
            <button className="combo-card" type="button">
              <span className="combo-card__title">Soba Earth</span>
              <span className="combo-card__text">Chilled buckwheat</span>
        ...
        <section className="combo-section">
          ...
          <div className="combo-section__grid combo-section__grid--three">
            <button className="combo-card combo-card--selected" type="button">
              <span className="combo-card__title">Seared Wagyu</span>
              <span className="combo-card__text">A5 grade strips</span>
            ...
            <button className="combo-card" type="button">
              <span className="combo-card__title">Bluefin Toro</span>
              <span className="combo-card__text">Fatty belly sashimi</span>
            ...
            <button className="combo-card" type="button">
              <span className="combo-card__title">Smoked Tofu</span>
              <span className="combo-card__text">Cherrywood fumed</span>
        ...
        <section className="combo-section">
          ...
          <div className="combo-section__grid combo-section__grid--three">
            <button className="combo-card" type="button">
              ...
              <span className="combo-card__text">Toasted seaweed</span>
            ...
            <button className="combo-card combo-card--selected" type="button">
              ...
              <span className="combo-card__text">Citrus essence</span>
            ...
            <button className="combo-card" type="button">
              <span className="combo-card__title">Daikon Lace</span>
              <span className="combo-card__text">Julienned radish</span>
              <span className="combo-card__price">5.00</span>
              <span className="combo-card__mobile-action">
                <span className="btn btn--light btn--small">+ ADD</span>
              </span>
            ...
            <button className="combo-card" type="button">
              <span className="combo-card__title">Shiso Leaf</span>
              <span className="combo-card__text">Wild japanese mint</span>
              <span className="combo-card__price">5.00</span>
              <span className="combo-card__mobile-action">
                <span className="btn btn--light btn--small">+ ADD</span>
              </span>
        ...
        <div className="combo-summary__container">
          ...
          <div className="combo-summary__stack">
            <article className="combo-layer combo-layer--fixed">
              ...
              <div className="combo-layer__aside combo-layer__aside--right">
                ...
                <button className="btn btn--link combo-layer__btn" type="button">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <article className="combo-layer combo-layer--draggable">
              ...
              <div className="combo-layer__main">
                <p className="combo-layer__title">Seared Wagyu</p>
                <p className="combo-layer__type">Filling</p>
              </div>
              <div className="combo-layer__aside combo-layer__aside--right">
                <span className="combo-layer__price">34.00</span>
                <button className="btn btn--link combo-layer__btn" type="button">
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
          ...
          <div className="combo-summary__totals">
            <div className="combo-summary__row">
              <span className="combo-summary__label">Base layers</span>
              <span className="combo-summary__value">10.00</span>
            </div>
            <div className="combo-summary__row">
              <span className="combo-summary__label">Added fillings</span>
              <span className="combo-summary__value">34.00</span>
            </div>
            <div className="combo-summary__row">
              <span className="combo-summary__label">Added toppings</span>
