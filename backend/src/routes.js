...
const guestOnly = (req, res, next) =>
	req.headers.authorization ? res.status(403).json({ error: 'Already authenticated' }) : next();
...
router.get('/adm/dishes/specials', auth, adminOnly, dishController.listDailySpecials);
