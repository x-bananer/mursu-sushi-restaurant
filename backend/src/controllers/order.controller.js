...
export const list               = placeholder('orders.list');
export const get                = placeholder('orders.get');
export const create             = placeholder('orders.create');
export const cancelOrder        = placeholder('orders.cancel');

export const tracking           = placeholder('orders.tracking');
export const journey            = placeholder('orders.journey');
